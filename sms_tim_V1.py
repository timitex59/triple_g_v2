...
def main():
    parser = argparse.ArgumentParser(description="SMS Tim V1 - Python/WebSocket TradingView")
    ...
    # Keep only BUY/SELL that are confirmed by CHG% CC DAILY.
    filtered = [r for r in results if r["trade"] in ("BUY", "SELL") and _chg_confirms_trade(r)]
